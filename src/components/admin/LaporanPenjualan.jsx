...
const LaporanPenjualan = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await axios.get('/api/reports/penjualan', {
  ...
  const handlePrint = useReactToPrint({
    contentRef: printRef,
    documentTitle: `Laporan_Penjualan_${dateRange.startDate}_${dateRange.endDate}`,
    onBeforeGetContent: () => {
  ...
  const calculateTotal = () => {
    return penjualan.reduce((total, item) => total + parseFloat(item.total_harga || 0), 0);
  };
        ...
        <table className="table table-bordered table-striped" style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ backgroundColor: '#f8f9fa' }}>
              ...
              <th style={{ border: '1px solid #dee2e6', padding: '8px' }}>Pelanggan</th>
              <th style={{ border: '1px solid #dee2e6', padding: '8px' }}>Kasir</th>
          ...
          <tbody>
            {penjualan.length > 0 ? (
              ...
              <tr>
                <td colSpan="6" style={{ border: '1px solid #dee2e6', padding: '8px', textAlign: 'center' }}>
          ...
          <tfoot>
            <tr style={{ backgroundColor: '#f8f9fa', fontWeight: 'bold' }}>
              <th colSpan="5" style={{ border: '1px solid #dee2e6', padding: '8px', textAlign: 'right' }}>
                Total
              </th>
    ...
    <div className="content-wrapper">
          ...
          <div className="row mb-2">
            ...
            <div className="col-sm-6">
              <ol className="breadcrumb float-sm-right">
                ...
                <li className="breadcrumb-item active">Laporan Penjualan</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <section className="content">
        <div className="container-fluid">
              ...
              <div className="row">
                ...
                <div className="col-md-2 d-flex align-items-end">
                  <button 
                    ...
                    onClick={handlePrint}
                    disabled={loading || penjualan.length === 0}
                  >
          ...
          <div className="card">
            <div className="card-header">
              <h3 className="card-title">Data Penjualan</h3>
            </div>
            <div className="card-body">
              {loading ? (
                        ...
                        {penjualan.length > 0 ? (
                          penjualan.map((item, index) => (
                            <tr key={item.id}>
                              ...
                              <td>{item.invoice || `INV-${item.id}`}</td>
